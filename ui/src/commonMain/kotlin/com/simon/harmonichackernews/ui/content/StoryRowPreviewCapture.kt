...
internal class StoryRowGeometry {
...
internal class StoryRowPreviewCapture(
    val geometry: StoryRowGeometry,
...
@Composable
internal fun rememberStoryRowPreviewCapture(
    style: StoryRowStyle,
    hasPreview: Boolean,
    listItem: Boolean,
...
): StoryRowPreviewCapture {
    val itemGeometry = remember { StoryRowGeometry() }
