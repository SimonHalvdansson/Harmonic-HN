...
object HarmonicThemeCatalog {
    ...
    private val materialFixedLight = create(
        ...
        mutedSurface = Color(0xFFF3EDF7),
        background = Color(0xFFF3EDF7),
        itemBackground = Color(0xFFFFFBFE),
        contentCardBackground = Color(0xFFF3EDF7),
        onPrimary = Color.White,
        onSecondary = Color.White,
    ...
    private val materialFixedDark = create(
        ...
        mutedSurface = Color(0xFF211F26),
        contentCardBackground = Color(0xFF211F26),
    ...
    private fun create(
        ...
        return HarmonicThemePalette(
            ...
            colors = HarmonicColors(
                ...
                iconTint = text.copy(alpha = text.alpha * 0.8f),
