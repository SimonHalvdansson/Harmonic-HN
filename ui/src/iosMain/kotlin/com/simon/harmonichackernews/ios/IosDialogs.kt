...
internal fun BoxScope.IosAppForeground(
    ...
    if (navigation.welcomeDialogVisible) {
        IosWelcomeDialog(app, scene.navigation::dismissWelcomeDialog)
    }
        ...
        LoginDialog(
            ...
            captchaDialog = { _, cancel, _ ->
                MessageActionDialog(
                    ...
                    message = "The CAPTCHA handoff is not yet connected to the iOS in-app " +
...
@Composable
internal fun IosUserProfileDialog(
    app: HarmonicAppComposition,
    scene: HarmonicSceneComposition,
    userName: String,
    onDismiss: () -> Unit,
