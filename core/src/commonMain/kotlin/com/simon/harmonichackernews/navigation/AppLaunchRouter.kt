...
sealed interface AppLaunchRequest {
    ...
    data class IncomingTextShare(val text: String?) : AppLaunchRequest
...
/** Common validation and navigation policy for Android intents, iOS URLs, and desktop launches. */
class AppLaunchRouter(
    ...
    fun route(request: AppLaunchRequest): AppLaunchResult = when (request) {
        ...
        is AppLaunchRequest.IncomingTextShare -> routeItemLink(
