...
class CommentsFeatureStore internal constructor(
    ...
    private val mutableEffects = MutableSharedFlow<CommentsFeatureEffect>(extraBufferCapacity = 64)
    override val effects: SharedFlow<CommentsFeatureEffect> = mutableEffects.asSharedFlow()
    ...
    override fun accept(intent: CommentsIntent) {
        ...
        when (intent) {
            ...
            is CommentsIntent.HeaderAction -> runtime.handleHeaderAction(intent.action)
            is CommentsIntent.ShareAction -> runtime.handleShareAction(intent.action)
            is CommentsIntent.MoreAction -> runtime.handleMoreAction(intent.action)
            ...
            is CommentsIntent.SheetAction -> runtime.handleSheetAction(intent.action)
