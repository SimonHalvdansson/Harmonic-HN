...
class ArchiveUrlResolverTest {
    ...
    private class Repository : LinkPreviewRepository {
        ...
        override suspend fun getHuggingFaceInfo(url: String): HuggingFaceModelInfo = error("Not used")
        override suspend fun getOpenRouterInfo(url: String): OpenRouterModelInfo = error("Not used")
