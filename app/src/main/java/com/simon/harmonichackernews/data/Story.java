...
public class Story {
    ...
    public transient boolean previewImageUrlNeedsRefresh;
    ...
    public transient String previewImageTintMode;
    ...
    public transient int faviconTintBaseColor;
    public transient String faviconTintMode;
    public int[] kids;
