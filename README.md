...
The purpose of open-sourcing Harmoinc is thus mainly to enable interested users to submit pull requests fixing issues or adding features. I would like to still be able to find my way around the app's code so I am not looking for a full Kotlin rewrite but if you want to make the app work better with foldables, fix a typo or add support for Android 13's themed icons all that would be much appreciated. I'll still commit things myself when I have time.
